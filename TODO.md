...
1. Эволюция
    ...
    8. [ок] Создаем нового участника evolution 
        1. Необходим механизм определения изменения состояния значений слоев
            1. Добавляем в слои счетчик и статистику.
            2. Добавляем в протокол команду ДРОП счетчика при которой счетчик размещается в статистике и скидывается в 0.
            3. Добавляем процессору инкремент счетчика если он не -1.
            4. Добавляем впротокол запрос статистики по слою.
            5. Эволюшен заправшивает статистику по ретине и анализирует статистику скорости обучения.
