...
1. Эволюция
    ...
    1. UI тормозит прерыванием запроса нета
        1. Дописываем условие на проверку локов <<<
        2. При синхронизации с сервером сначала читаем все из сети ... и располагая всеми данными обновляем только после этого net при этом его блокируя.
            1. Залочили
            2. прочитали бинарники.
            3. рзлочили
            4. сбегали по сети
            5. залочили
            6. записали в нет
